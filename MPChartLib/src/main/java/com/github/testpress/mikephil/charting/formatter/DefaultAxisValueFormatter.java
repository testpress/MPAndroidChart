...
public class DefaultAxisValueFormatter implements AxisValueFormatter {
     ...
     */
    protected com.github.testpress.mikephil.charting.formatter.FormattedStringCache.PrimFloat mFormattedStringCache;
    ...
    public DefaultAxisValueFormatter(int digits) {
        ...
        mFormattedStringCache = new com.github.testpress.mikephil.charting.formatter.FormattedStringCache.PrimFloat(new DecimalFormat("###,###,###,##0" + b.toString()));
    }
