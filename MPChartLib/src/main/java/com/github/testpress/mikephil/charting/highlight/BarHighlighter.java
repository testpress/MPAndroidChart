...
public class BarHighlighter extends ChartHighlighter<BarDataProvider> {
    ...
    public com.github.testpress.mikephil.charting.highlight.Highlight getHighlight(float x, float y) {
        com.github.testpress.mikephil.charting.highlight.Highlight high = super.getHighlight(x, y);
     ...
     * @return
     */
    public com.github.testpress.mikephil.charting.highlight.Highlight getStackedHighlight(com.github.testpress.mikephil.charting.highlight.Highlight high, IBarDataSet set, float xVal, float yVal) {
        ...
        if (entry.getYVals() == null) {
            ...
            com.github.testpress.mikephil.charting.highlight.Range[] ranges = entry.getRanges();
            ...
            if (ranges.length > 0) {
                ...
                com.github.testpress.mikephil.charting.highlight.Highlight stackedHigh = new com.github.testpress.mikephil.charting.highlight.Highlight(
                        entry.getX(),
                        entry.getY(),
                        (float) pixels.x,
                        (float) pixels.y,
     ...
     * @return
     */
    protected int getClosestStackIndex(com.github.testpress.mikephil.charting.highlight.Range[] ranges, float value) {
        ...
        for (com.github.testpress.mikephil.charting.highlight.Range range : ranges) {
