...
public class ChartHighlighter<T extends BarLineScatterCandleBubbleDataProvider> implements Highlighter {
    ...
    public com.github.testpress.mikephil.charting.highlight.Highlight getHighlight(float x, float y) {
        ...
        com.github.testpress.mikephil.charting.highlight.Highlight high = getHighlightForX(xVal, x, y);
        return high;
    }
     ...
     * @return
     */
    protected com.github.testpress.mikephil.charting.highlight.Highlight getHighlightForX(float xVal, float x, float y) {

        List<com.github.testpress.mikephil.charting.highlight.Highlight> closestValues = getHighlightsAtXPos(xVal, x, y);
        ...
        com.github.testpress.mikephil.charting.highlight.Highlight detail = getClosestHighlightByPixel(closestValues, x, y, axis, mChart.getMaxHighlightDistance());
     ...
     * @return
     */
    protected float getMinimumDistance(List<com.github.testpress.mikephil.charting.highlight.Highlight> closestValues, float pos, YAxis.AxisDependency axis) {

        float distance = Float.MAX_VALUE;

        for (int i = 0; i < closestValues.size(); i++) {

            com.github.testpress.mikephil.charting.highlight.Highlight high = closestValues.get(i);
    ...
    protected float getHighlightPos(com.github.testpress.mikephil.charting.highlight.Highlight h) {
        return h.getYPx();
    }
     ...
     * @return
     */
    protected List<com.github.testpress.mikephil.charting.highlight.Highlight> getHighlightsAtXPos(float xVal, float x, float y) {
        ...
        for (int i = 0, dataSetCount = data.getDataSetCount(); i < dataSetCount; i++) {
            ...
            com.github.testpress.mikephil.charting.highlight.Highlight high = buildHighlight(dataSet, i, xVal, DataSet.Rounding.CLOSEST);
     ...
     * @return
     */
    public com.github.testpress.mikephil.charting.highlight.Highlight getClosestHighlightByPixel(List<com.github.testpress.mikephil.charting.highlight.Highlight> closestValues, float x, float y,
                                                                                                 YAxis.AxisDependency axis, float minSelectionDistance) {

        com.github.testpress.mikephil.charting.highlight.Highlight closest = null;
