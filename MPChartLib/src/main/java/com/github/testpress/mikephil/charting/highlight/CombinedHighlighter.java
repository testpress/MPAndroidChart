...
import com.github.testpress.mikephil.charting.interfaces.dataprovider.CombinedDataProvider;
 ...
 */
public class CombinedHighlighter extends ChartHighlighter<CombinedDataProvider> implements com.github.testpress.mikephil.charting.highlight.Highlighter {

    /**
     * bar highlighter for supporting stacked highlighting
     */
    protected com.github.testpress.mikephil.charting.highlight.BarHighlighter barHighlighter;

    public CombinedHighlighter(CombinedDataProvider chart, BarDataProvider barChart) {
        super(chart);

        // if there is BarData, create a BarHighlighter
        barHighlighter = barChart.getBarData() == null ? null : new com.github.testpress.mikephil.charting.highlight.BarHighlighter(barChart);
    }
    ...
    protected List<com.github.testpress.mikephil.charting.highlight.Highlight> getHighlightsAtXPos(float xVal, float x, float y) {
        ...
        for (int i = 0; i < dataObjects.size(); i++) {
            ...
            if (barHighlighter != null && dataObject instanceof BarData) {
                com.github.testpress.mikephil.charting.highlight.Highlight high = barHighlighter.getHighlight(x, y);
                ...
                for (int j = 0, dataSetCount = dataObject.getDataSetCount(); j < dataSetCount; j++) {
                    ...
                    com.github.testpress.mikephil.charting.highlight.Highlight s1 = buildHighlight(dataSet, j, xVal, DataSet.Rounding.CLOSEST);
                    s1.setDataIndex(i);
