...
import com.github.testpress.mikephil.charting.charts.RadarChart;
...
public class RadarHighlighter extends PieRadarHighlighter<RadarChart> {
    ...
    protected com.github.testpress.mikephil.charting.highlight.Highlight getClosestHighlight(int index, float x, float y) {
        ...
        List<com.github.testpress.mikephil.charting.highlight.Highlight> highlights = getHighlightsAtIndex(index);
        ...
        for (int i = 0; i < highlights.size(); i++) {
            ...
            com.github.testpress.mikephil.charting.highlight.Highlight high = highlights.get(i);
     ...
     * @return
     */
    protected List<com.github.testpress.mikephil.charting.highlight.Highlight> getHighlightsAtIndex(int index) {
        ...
        for (int i = 0; i < mChart.getData().getDataSetCount(); i++) {
            ...
            mHighlightBuffer.add(new com.github.testpress.mikephil.charting.highlight.Highlight(index, entry.getY(), pOut.x, pOut.y, i, dataSet.getAxisDependency()));
        }
