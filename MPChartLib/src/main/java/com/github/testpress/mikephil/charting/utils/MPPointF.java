 ...
 */
public class MPPointF extends com.github.testpress.mikephil.charting.utils.ObjectPool.Poolable {

    private static com.github.testpress.mikephil.charting.utils.ObjectPool<MPPointF> pool;

    public float x;
    public float y;

    static {
        pool = com.github.testpress.mikephil.charting.utils.ObjectPool.create(32, new MPPointF(0,0));
