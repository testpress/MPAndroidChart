...
public abstract class Utils {
     ...
     */
    public static com.github.testpress.mikephil.charting.utils.FSize calcTextSize(Paint paint, String demoText) {

        com.github.testpress.mikephil.charting.utils.FSize result = com.github.testpress.mikephil.charting.utils.FSize.getInstance(0,0);
     ...
     */
    public static void calcTextSize(Paint paint, String demoText, com.github.testpress.mikephil.charting.utils.FSize outputFSize) {
    ...
    public static void drawXAxisValue(Canvas c, String text, float x, float y,
        ...
        if (angleDegrees != 0.f) {
            ...
            if (anchor.x != 0.5f || anchor.y != 0.5f) {
                final com.github.testpress.mikephil.charting.utils.FSize rotatedSize = getSizeOfRotatedRectangleByDegrees(
                ...
                com.github.testpress.mikephil.charting.utils.FSize.recycleInstance(rotatedSize);
            }
    ...
    public static void drawMultilineText(Canvas c, String text,
                                         float x, float y,
                                         TextPaint paint,
                                         com.github.testpress.mikephil.charting.utils.FSize constrainedToSize,
                                         MPPointF anchor, float angleDegrees) {
     ...
     * @return A Recyclable FSize instance
     */
    public static com.github.testpress.mikephil.charting.utils.FSize getSizeOfRotatedRectangleByDegrees(com.github.testpress.mikephil.charting.utils.FSize rectangleSize, float degrees) {
     ...
     * @return A Recyclable FSize instance
     */
    public static com.github.testpress.mikephil.charting.utils.FSize getSizeOfRotatedRectangleByRadians(com.github.testpress.mikephil.charting.utils.FSize rectangleSize, float radians) {
        return getSizeOfRotatedRectangleByRadians(rectangleSize.width, rectangleSize.height,
                radians);
    }
     ...
     * @return A Recyclable FSize instance
     */
    public static com.github.testpress.mikephil.charting.utils.FSize getSizeOfRotatedRectangleByDegrees(float rectangleWidth, float
     ...
     * @return A Recyclable FSize instance
     */
    public static com.github.testpress.mikephil.charting.utils.FSize getSizeOfRotatedRectangleByRadians(float rectangleWidth, float
            rectangleHeight, float radians) {
        return com.github.testpress.mikephil.charting.utils.FSize.getInstance(
